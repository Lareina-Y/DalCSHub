        ...
        <div class='contactbox'>
            <div class='contact1' style={{padding: "3%"}}>
              <div style={{padding: "3%", height: "350px"}}>
                ...
                <Box
                  ...
                  <Typography variant='body'>
                    <label>Name:&nbsp;</label>
                    <input type='text' size={150} style={{width: "100%", marginBottom: "15px"}}></input>
                  </Typography>
                </Box>
                <Box
                  sx={{justifyContent:"center",
                ...
                >
                  <Typography variant='body'>
                    <textarea rows={10} cols={150} style={{width: "100%"}} placeholder="Enter your quries here..."></textarea>
                  </Typography>
                </Box>
              </div>
            ...
            <div class="contact2" style={{padding: "3%"}}>
              <div style={{padding: "3%", height: "350px"}}>       
                ...
                >
                  <Typography variant='body'>
                    We are just one step-away. Send us all yours question by just emailing us and we will be 
                    happy to serve you.
                  </Typography>
                </Box>
              </div> 
              <Box textAlign='center'>
                <Button variant="contained" color="secondary" href="mailto:contactdalcshub@dal.ca">Email</Button>
              </Box>
            </div>
        </div>
    </Page>
